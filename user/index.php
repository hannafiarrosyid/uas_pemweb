...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        <span class="brand-text font-weight-light">UAS</span>
      </a>
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
      apa yang kamu ingin tau?
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2023 <a href="https://ump.ac.id/">UMP</a>.</strong> All rights reserved. | Repost by <a href='https://www.instagram.com/hannafiarrosyid12345/' title='Hannafi Arrosyid' target='_blank'>Hannafi Arrosyid</a>
  </footer>
</div>
<!-- ./wrapper -->
